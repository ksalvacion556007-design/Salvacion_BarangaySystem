...
<html>
<head>
    <title>Admin Reports — Barangay Kingking</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="/admin/reports" class="nav-item active">Reports</a>
        </nav>
    ...
    <div class="main-wrap">
        ...
        <div class="content">
            ...
            <div class="stat-grid no-print">
                ...
                <div class="stat-card s-clerk">
                    <div class="stat-num">{{ $clerkCount }}</div>
                    <div class="stat-label">Clerks</div>
                </div>
                <div class="stat-card s-secretary">
                    <div class="stat-num">{{ $secretaryCount }}</div>
                ...
                <tbody id="logsTableBody">
                    ...
                    <tr class="log-row">
                        <td>
                            {{ $log->user
                                ? $log->user->first_name . ' ' .
                                ($log->user->middle_name ? strtoupper(substr($log->user->middle_name,0,1)).'. ' : '') .
                                $log->user->last_name
                                : 'N/A' }}
                        </td>
                        <td>{{ $log->action }}</td>
            ...
            <div class="print-section">
                ...
                <div style="text-align:center; margin: 10px 0 16px;">
                    <div style="font-size:16px; font-weight:bold; text-transform:uppercase; letter-spacing:2px;">
                        Staff Account Management Report
                    </div>
                ...
                <div style="margin-bottom: 18px; text-align:center;">
                    <table style="width:50%; margin: 0 auto;">
                        ...
                        <tr>
                            <td style="padding:6px 10px; border:1px solid #000;">Total Staff Accounts</td>
                            <td style="text-align:center; padding:6px 10px; border:1px solid #000;">{{ $total }}</td>
                        </tr>
                        <tr>
                            <td style="padding:6px 10px; border:1px solid #000;">Clerks</td>
                            <td style="text-align:center; padding:6px 10px; border:1px solid #000;">{{ $clerkCount }}</td>
                        </tr>
                        <tr>
                            <td style="padding:6px 10px; border:1px solid #000;">Secretaries</td>
